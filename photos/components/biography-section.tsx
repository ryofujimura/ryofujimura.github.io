...
const timelineEvents = [
  {
    year: "1452",
    title: "Birth",
    description: "Born in Vinci, Republic of Florence, as the illegitimate son of a notary.",
  },
  {
    year: "1466",
    title: "Apprenticeship",
    description: "Begins training in the workshop of Andrea del Verrocchio in Florence.",
  },
  {
    year: "1482",
    title: "Milan",
    description: "Moves to Milan to work for Duke Ludovico Sforza.",
  },
  {
    year: "1495",
    title: "The Last Supper",
    description: "Begins work on his monumental mural in Santa Maria delle Grazie.",
  },
  {
    year: "1503",
    title: "Mona Lisa",
    description: "Starts painting his most famous portrait, which he worked on for years.",
  },
  {
    year: "1519",
    title: "Legacy",
    description: "Dies at Clos Lucé, France, leaving behind an unparalleled artistic legacy.",
  },
];
